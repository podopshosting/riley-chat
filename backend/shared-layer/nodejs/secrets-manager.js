...
class SecretsManager {
    ...
    async getOpenAICredentials() {
        return this.getSecret('OpenAICredentials');
    }

    async getPodOpsCredentials() {
        return this.getSecret('PodOpsCredentials');
    }

    async getPandaAdminCredentials() {
        return this.getSecret('PandaAdminCredentials');
    }
}
